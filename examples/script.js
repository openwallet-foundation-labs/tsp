    ...
    <div class="card mb-4 text-bg-light" style="max-width:40rem">
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">
            ...
            <pre class="text-primary-emphasis mb-0">${
              identity.publicSigkey
            }</pre>
        </li>
        <li class="list-group-item">
            <span class="badge text-bg-info float-end">public</span>
...
function renderMessage(message) {
  ...
  parts.forEach((part, index) => {
    if (message[part]) {
      addSpan(messageParts, message[part].data, "message-part", {
        color: colors[index],
      });
    }
  });
  ...
  parts.forEach((part, index) => {
    ...
    if (part === "sender" || part === "signature") {
      ...
      addSpan(
        ...
        "badge text-bg-secondary float-end",
    ...
    addSpan(
      li,
      `CESR selector: ${message[part].prefix}`,
      "message-part d-block"
    );
    addSpan(li, message[part].data, "message-part d-block", {
      color: colors[index],
    });
