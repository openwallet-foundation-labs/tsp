...
mod tests {
    ...
    async fn test_create_webvh_success() {
        ...
        let (vid, genesis_log_entry, webvh_update_key_public, private_key_bytes) = result.unwrap();
        // 3. Assert
        ...
        // Encode the derived public key into the same multibase format
        // let rederived_public_key_multibase =
        //     hpke::OpModeR::encode(hpke::OpModeR::Base58Btc, verifying_key.as_bytes());
